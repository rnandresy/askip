...
val ALL_ACHIEVEMENTS = listOf(
    ...
    AchievementDef("fifty_posts",    "Grande Gueule",        "50 posts. La parole est libre, profites-en !",       "#5C6BC0", "légendaire"),

    // ── Commenter ─────────────────────────────────────────────────────────────
    AchievementDef("first_comment",  "Premier Mot",         "Tu as laissé ton premier commentaire.",              "#2196F3", "commun"),
    AchievementDef("commentator",    "Bavard Sympa",         "20 commentaires. Tu gardes la conversation vivante.","#1976D2", "rare"),
    ...
    AchievementDef("dark_confessor", "Agent Double",         "5 confessions. Qui se cache derrière ce masque ?",   "#37474F", "rare"),

    // ── Sondage ───────────────────────────────────────────────────────────────
    AchievementDef("poll_creator",   "Sondeur",             "3 sondages créés. Tu veux savoir ce que pensent tes collègues !","#009688","commun"),
    AchievementDef("poll_master",    "Démocrate du Campus",  "10 sondages. La parole est à tout le monde grâce à toi.","#00695C","rare"),
    ...
    AchievementDef("badge_maker",    "Créateur de Badge",   "Tu as créé ton propre badge. Original !",            "#7C4DFF", "rare"),
